...
exports.v1_LeaderboardCategory = void 0;
const getLeaderboard_1 = require("./getLeaderboard");
class v1_LeaderboardCategory {
    constructor(apiKey) {
        this.apiKey = apiKey;
    }
    /**
     ...
     */
    get(affinity, season, name, tag) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield (0, getLeaderboard_1.v1_getLeaderboard)(this.apiKey, affinity, season, name, tag);
        });
    }
}
exports.v1_LeaderboardCategory = v1_LeaderboardCategory;
