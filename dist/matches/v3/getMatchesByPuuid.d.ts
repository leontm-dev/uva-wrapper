export declare function v3_getMatchesByPuuid(apiKey: string, affinity: string, puuid: string, mode?: string, map?: string, size?: number): Promise<import("../../types/response.type").DefaultApiResponse<v3_getMatchesByPuuid_ResponseData[]> | import("../../types/response.type").DefaultErrorsResponse>;
export interface v3_getMatchesByPuuid_ResponseData {
    coaches: {
        puuid: string;
        team: string;
    }[];
