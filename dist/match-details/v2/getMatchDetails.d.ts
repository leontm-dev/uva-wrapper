export declare function v2_getMatchDetails(apiKey: string, matchId: string): Promise<import("../../types/response.type").DefaultApiResponse<unknown> | import("../../types/response.type").DefaultErrorsResponse>;
export interface v2_getMatchDetails_ResponseData {
    coaches: {
        puuid: string;
        team: string;
    }[];
